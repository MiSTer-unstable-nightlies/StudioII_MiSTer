...
reg [15:0] snd_control_half;
reg [15:0] snd_cnt;
reg [15:0] snd_cycle_base;
reg [14:0] snd_cycle_scale;
...
function automatic [14:0] snd_tune_period_scale(input [2:0] value);
begin
	case (value)
		...
		if (q || (snd_amp != 8'd0)) begin
			if (snd_cnt >= snd_toggle_at) begin
				...
				if (!snd_out) begin
					...
					snd_cycle_scale <= snd_tune_period_scale(tuning);
